...
object Competition extends App {
  ...
  //  val results: Array[(String, Int)] =  new Array[(String,Int)](locals.size*foreigners.size)
  ...
  val result = finalResult match {
    case fr: Int if fr > 0 => "Наша взяла"
    case fr: Int if fr < 0 => "Продули"
